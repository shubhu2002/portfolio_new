...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative flex min-h-screen items-center overflow-hidden bg-primary">
      ...
      <div className="relative z-10 flex w-full flex-col px-4 md:px-16 lg:px-24">
        ...
        <div className="mt-8 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <p className="hero-fade-in max-w-sm font-helvetica-light text-sm leading-relaxed text-white/40">
