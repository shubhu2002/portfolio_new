    ...
    >
      ...
      >
        <div
          ...
          // remove  bg-black
          className="absolute left-1/2 top-1/2 flex  items-start justify-start overflow-hidden shadow-deep-inset  rounded-2xl  border border-white/[0.1] px-4 py-1 pb-4  transition duration-700 group-hover/pin:border-white/[0.2]"
        >
