    ...
    >
      ...
      >
        <div
          ...
          // remove  bg-black
          className="absolute left-1/2 top-1/2 flex  items-start justify-start overflow-hidden rounded-2xl  border  border-white/[0.1] px-4 py-1 pb-4 shadow-deep-inset  transition duration-700 group-hover/pin:border-white/[0.2]"
        >
        ...
        <div className=" inset-0 -mt-7 h-full w-full  flex-none">
          <div className="absolute inset-x-0 top-0  flex justify-center">
            <div className="relative z-10 flex items-center space-x-2 rounded-full bg-zinc-950 px-4 py-0.5 ring-1 ring-white/10 ">
              <span className="relative z-20 inline-block text-nowrap py-0.5 text-xs font-bold text-white">
                {title}
              </span>
